...
* Learn more about Esri's [ArcGIS for the Military solution](@"host:"xhttp://84.234.96.47/main/").
* [squad-leader-android repository](@"host:"xhttp://84.234.96.47/main/")
...
- Use of the JUnit library available at https://github.com/junit-team/junit is governed by the (@"host:"xhttp://84.234.96.47/main/").
